...
name con el valor del parámetro name subscribers con el valor del parámetro subs hash, con el valor de la longitud del string name multiplicado por el parámetro subs
...
El método getStatus debe devolver el texto, NO imprimirlo por consola. */
...
const jesica = createObject("name", 50);
console.log(jesica.getStatus());
